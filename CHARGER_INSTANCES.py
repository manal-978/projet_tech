...
# note respect other members code
# non: -
# and: &
# or: |

# this code can work on many sentences on the inputfile
...
if __name__ == "__main__":
    inputs = open(
        r'c:\Users\herra\OneDrive\Bureau\Studies\me ing2\S8\input.txt').read().split('\n')
    output = open(
        'c:\\Users\\herra\\OneDrive\\Bureau\\Studies\\me ing2\\S8\\output.txt', 'w')
    for input in inputs:
